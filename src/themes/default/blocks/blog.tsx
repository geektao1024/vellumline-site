        ...
        {posts && posts.length > 0 ? (
          <div className="flex w-full flex-wrap items-start">
            {posts?.map((item, idx) => (
              ...
              >
                <div className="bg-card/45 border-border/75 hover:border-primary/35 hover:bg-accent/15 flex flex-col overflow-clip rounded-[var(--radius-panel)] border shadow-sm backdrop-blur-sm transition-[background-color,border-color,box-shadow] duration-[var(--dur-short)]">
                  {item.image && (
                    <div>
                      <img
                        src={item.image}
                          ...
                          {item.author_image && (
                            <Avatar>
                              <AvatarImage
                                ...
                                className="size-6 rounded-[var(--radius-control)]"
                              />
                              <AvatarFallback>

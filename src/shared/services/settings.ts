...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    },
    {
      ...
      placeholder:
        'Vellum & Line is a browser-based studio for creating custom map posters and printable map art.',
      type: 'textarea',
      group: 'appinfo',
      tab: 'general',
    },
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      type: 'text',
      placeholder: 'Vellum & Line <no-reply@vellumline.app>',
      group: 'resend',
      tab: 'email',
    },
    {

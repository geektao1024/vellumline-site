...
- [ ] **Blog / content pages** — Add server-rendered pages (e.g. "How to create custom map art") to drive organic traffic; an SPA alone is limited since Google mostly sees a single URL
- [ ] **Submit to directories** — List Vellum & Line on Product Hunt, AlternativeTo, Futurepedia, and similar design-tool directories
- [ ] **OpenStreetMap community** — Showcase Vellum & Line in OSM forums, wiki tool pages, and community channels

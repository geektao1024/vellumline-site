...
const LAYOUT_SYMBOL_STROKE = "#E2C985";
const LAYOUT_SYMBOL_FILL = "#B98935";

const fallbackSymbol =
  `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 40'><rect x='2' y='2' width='60' height='36' rx='5' fill='none' stroke='${LAYOUT_SYMBOL_STROKE}' stroke-width='2'/><rect x='14' y='8' width='36' height='24' rx='3' fill='${LAYOUT_SYMBOL_FILL}'/></svg>`;
...
function createSymbolFromRatio(width: number, height: number): string {
  ...
  return `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 40'><rect x='2' y='2' width='60' height='36' rx='5' fill='none' stroke='${LAYOUT_SYMBOL_STROKE}' stroke-width='2'/><rect x='${roundedX}' y='${roundedY}' width='${roundedWidth}' height='${roundedHeight}' rx='3' fill='${LAYOUT_SYMBOL_FILL}'/></svg>`;
}

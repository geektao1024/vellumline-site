...
const categoryConfig: Record<UpdateCategory, CategoryMeta> = {
  ...
  fixed: { code: "FIX", label: "Fixed" },
  improved: { code: "UPD", label: "Improved" },
  info: { code: "INF", label: "Info" },
  community: { code: "COM", label: "Community" },
  docs: { code: "DOC", label: "Docs" },
  roadmap: { code: "MAP", label: "Roadmap" },
  removed: { code: "REM", label: "Removed" },
  security: { code: "SEC", label: "Security" },
  breaking: { code: "BRK", label: "Breaking" },
  major: { code: "MAJ", label: "Major" },
  perf: { code: "PER", label: "Performance" },
  core: { code: "COR", label: "Core" },
};

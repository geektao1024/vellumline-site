...
export const ADBLOCK_LIMIT_EVENT = "vellum-line:adblock-limit";
export const ADBLOCK_WARN_EVENT = "vellum-line:adblock-warn";

const EXPORT_COUNT_STORAGE_KEY = "vellum-line.poster.count";
...
export const SUPPORT_PROMPT_EVENT = "vellum-line:support-prompt";

...
/** New York City — default fallback when geolocation is denied. */
...
export const APP_CREDIT_URL =
  import.meta.env.VITE_APP_CREDIT_URL ?? "vellumline.app";
...
export const POSTER_TITLE_FONT_STACK =
  '"Literata", "Manrope", serif';
export const POSTER_META_FONT_STACK = '"Spline Sans Mono", monospace';

export const FONT_OPTIONS: FontOption[] = [
  { value: "", label: "Default (Literata)" },

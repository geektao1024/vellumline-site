  ...
  return (
    <section className="info-panel-section">
      ...
      <p className="hug-copy">
        Vellum & Line runs in your browser and keeps this validation fork open-source.
        Help shape the next version of printable map art.
      </p>
          ...
          <div className="hug-row-content">
            {repoUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Open Vellum & Line repository on GitHub"
              >
            ...
            {repoUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Star Vellum & Line on GitHub"
              >
            ...
            {kofiUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label="Support Vellum & Line on Ko-fi"
              >
            ...
            {socialLinks.map(({ href, Icon, label }) =>
              href ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  aria-label={`Follow Vellum & Line on ${label}`}
                  title={label}
                >

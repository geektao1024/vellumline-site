            ...
            {tabs.map(({ id, label, Icon }) => {
              ...
              return (
                <button
                  ...
                  aria-current={!isLocationTab && isActive ? "page" : undefined}
                  aria-pressed={isLocationTab ? isLocationVisible : undefined}
                  aria-expanded={!isLocationTab ? isActive : undefined}
                  aria-controls={!isLocationTab ? "mobile-settings-drawer" : undefined}
                >

...
export default function DesktopLocationBar() {
  ...
  return (
    <div
      className={`dsk-loc-bar${showCoords ? " show-coords" : ""}${
        locationPermissionMessage ? " has-location-message" : ""
      }`}
    >
      <div className="location-autocomplete">
        ...
        {locationPermissionMessage ? (
          <p className="location-permission-message" role="status" aria-live="polite">
            {locationPermissionMessage}
          </p>
        ) : null}
